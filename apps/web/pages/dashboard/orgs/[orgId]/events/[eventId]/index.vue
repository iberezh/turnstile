    ...
    <div>
      ...
      <div class="mt-1 flex flex-wrap items-center justify-between gap-3">
        ...
        <div class="flex items-center gap-2">
          <NuxtLink :to="`/dashboard/orgs/${orgId}/events/${eventId}/orders`">
            <Button variant="outline" size="sm">Orders</Button>
          </NuxtLink>
          <NuxtLink :to="`/dashboard/orgs/${orgId}/events/${eventId}/promos`">
            <Button variant="outline" size="sm">Promos</Button>
          </NuxtLink>
          <NuxtLink :to="`/dashboard/orgs/${orgId}/events/${eventId}/scanner`">
